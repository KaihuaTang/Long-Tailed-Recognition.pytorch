...
class HybridTaskCascadeRoIHead(CascadeRoIHead):
    ...
    def _bbox_forward_train(self,
        ...
        bbox_results = self._bbox_forward(
            stage, x, rois, semantic_feat=semantic_feat, gt_label=bbox_targets[0])
    ...
    def _bbox_forward(self, stage, x, rois, semantic_feat=None, gt_label=None):
        ...
        cls_score, bbox_pred = bbox_head(bbox_feats, gt_label)
